...
function UnderGameBoard(props) {
    const {updateScore, score, updateSudokuBoard, sudokuBoard, solution, boardColors, updateBoardColors } = props;
  return (
            ...
            <Row className="w-100 justify-content-center m-auto mb-5">
                <Col className='d-flex flex-col justify-content-between col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4 p-0'>
                    {/* <Row className='justify-content-center'> */}
                        <GambleButton score={score} updateScore={updateScore} updateSudokuBoard={updateSudokuBoard} sudokuBoard={sudokuBoard} solution={solution} boardColors={boardColors} updateBoardColors={updateBoardColors}/>
                        <MotivationButton />
                    {/* </Row> */}
                </Col>
